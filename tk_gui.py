...
class HockeyGui(hockey_gui_handler.HockeyGuiHandler):
    ...
    def __init__(self, **kwargs):
        ...
        self.statistics.add_command(label="1 ...", command=self.statistics_1)
        self.statistics.add_command(label="2 ...", command=self.statistics_2)
        self.statistics.add_command(label="3 ...", command=self.statistics_3)
        self.statistics.add_command(label="4 ...", command=self.statistics_4)
        self.statistics.add_command(label="5 ...", command=self.statistics_5)
